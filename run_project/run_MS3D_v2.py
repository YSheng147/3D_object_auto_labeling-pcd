...
MODEL_CFG_FILE = SCRIPT_DIR / "cfgs/all_model_config.csv"
...
def main():
    ...
    for i, found_path in enumerate(found_paths):
        ...
        if not args.force_data and pc_pkl_path.is_file():
            ...
            run_command(["bash", str(SCRIPT_DIR / "scripts/data_processing.sh"), str(found_path)], cwd=SCRIPT_DIR / "scripts")
        ...
        # 統計
        run_command(["python", str(SCRIPT_DIR / "stats/class_statistics.py"), str(target_pkl)])
