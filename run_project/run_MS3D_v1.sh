...
for dir in "$SOURCE_DIR"/*; do
    ...
    # 尋找點雲資料夾
    found_path=$(find "$dir" -maxdepth 1 -type d -iname "*vls128*pcd*" | head -n 1)
    ...
    # dataset name
    dataset_name="$(basename $SOURCE_DIR)-$(basename $dir)"
    ...
    cp "$result_dir/final_ps_dict_conv.pkl" "$dir/3d_label.pkl"
    # 統計
    python class_statistics.py "$dir/3d_label.pkl"
    popd
done