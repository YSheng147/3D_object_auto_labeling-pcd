...
CFG_FILE="../model_zoo/waymo/cfgs/waymo_uda_voxel_rcnn_centerhead_4xyzt_allcls.yaml"
CKPT_FILE="../model_zoo/waymo/waymo_uda_voxel_rcnn_centerhead_4xyzt_allcls.pth"
