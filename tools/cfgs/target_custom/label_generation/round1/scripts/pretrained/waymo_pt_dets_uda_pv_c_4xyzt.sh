...
CFG_FILE="../model_zoo/waymo/cfgs/waymo_uda_pv_rcnn_plusplus_resnet_centerhead_4xyzt_allcls.yaml"
CKPT_FILE="../model_zoo/waymo/waymo_uda_pv_rcnn_plusplus_resnet_centerhead_4xyzt_allcls.pth"
